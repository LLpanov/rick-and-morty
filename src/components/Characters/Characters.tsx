			...
			<section className={' flex flex-col mt-10 justify-center items-center'}>
				...
				<form onSubmit={handleSubmit(onSubmit)}>
					...
					<div className='relative'>
						...
						<input type='search' {...register('name')} id='default-search' className={'dark:placeholder-gray-100 dark:text-green-50 block w-[550px] rounded-lg border border-gray-300 bg-gray-50 p-4 pl-10 text-[16px] text-gray-500  focus:ring-gray-500 dark:border-gray-500 dark:bg-gray-400 dark:focus:border-grey-600 dark:focus:ring-gray-500;'} placeholder='Search characters...' />
