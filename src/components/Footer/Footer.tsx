...
const Footer: FC = () => {
	return (
		<LazyLoad height={200} once>
			<section className='bg-gradient-to-r from-gray-500 to-gray-500 '>
				<div className='max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8'>
					...
					<div className='flex justify-center mt-8 space-x-6'>
						...
						<a href='https://www.linkedin.com/in/leonid-panov/' className='text-gray-200'>
							...
							<svg className='h-6 w-6 ' aria-hidden='true' viewBox='0 0 24 24' fill='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
					...
					<p className='mt-8 text-base text-gray-200 leading-6 text-center '>© 2022 Created by Leonid Panov</p>
				</div>
			</section>
		</LazyLoad>
	);
