	...
	return (
		<>
			<section className={styles.locationCard}>
				<svg className='h-16 w-16 text-white' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='limegreen' fill='none' stroke-linecap='round' stroke-linejoin='round'>
