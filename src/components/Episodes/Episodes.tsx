            ...
            <section className='flex justify-center mt-10 mb-5'>
                <nav aria-label='Page navigation example'>
                    <ul className='flex list-style-none'>
                        ...
                        <li className='page-item'>
                            <button
                                className='page-link relative block py-1.5 px-3   bg-transparent outline-none transition-all duration-300 rounded text-gray-800 hover:text-gray-800 hover:bg-gray-300 focus:shadow-none'
